...
from app.schemas import Category as CategorySchema, CategoryDetail
from app.models import Category, Product, Conf, ConfType
from app.schemas import ProductList, Products


async def get_categories(language: str, session: AsyncSession) -> List[CategorySchema]:
