...
class ProductSpecificationType(Base):
    ...
    product_variant_specifications: Mapped[List["ProductVariantSpecification"]] = relationship("ProductVariantSpecification", back_populates="specification_type")
...
class ProductVariant(Base):
    ...
    specifications: Mapped[List["ProductVariantSpecification"]] = relationship("ProductVariantSpecification", back_populates="product_variant")


class ProductVariantSpecification(Base):
    __tablename__ = 'product_variant_specifications'

    id: Mapped[int] = mapped_column(primary_key=True)
    name_en: Mapped[str] = mapped_column(nullable=False)
    name_ro: Mapped[str] = mapped_column(nullable=False)
    product_variant_id: Mapped[int] = mapped_column(ForeignKey("product_variants.id"), nullable=False)
    product_variant: Mapped["ProductVariant"] = relationship("ProductVariant", back_populates="specifications")
    specification_type_id: Mapped[int] = mapped_column(ForeignKey("product_specification_types.id"), nullable=False)
    specification_type: Mapped["ProductSpecificationType"] = relationship("ProductSpecificationType", back_populates="product_variant_specifications")
