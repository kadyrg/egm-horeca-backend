...
def upgrade() -> None:
    ...
    op.add_column('product_specification_types', sa.Column('name_en', sa.String(), nullable=False))
    op.add_column('product_specification_types', sa.Column('name_ro', sa.String(), nullable=False))
    ...
    op.add_column('product_specifications', sa.Column('name_en', sa.String(), nullable=False))
    op.add_column('product_specifications', sa.Column('name_ro', sa.String(), nullable=False))
    op.add_column('product_variant_specifications', sa.Column('name_en', sa.String(), nullable=False))
    op.add_column('product_variant_specifications', sa.Column('name_ro', sa.String(), nullable=False))
    op.add_column('product_variant_types', sa.Column('name_en', sa.String(), nullable=False))
    op.add_column('product_variant_types', sa.Column('name_ro', sa.String(), nullable=False))
    ...
    op.add_column('product_variants', sa.Column('description_en', sa.String(), nullable=False))
    op.add_column('product_variants', sa.Column('description_ro', sa.String(), nullable=False))
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('category_translations_category_id_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('category_translations_language_code_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('category_translations_pkey')),
    sa.UniqueConstraint('slug', name=op.f('category_translations_slug_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('product_specific_translations',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('product_specification_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('language_code_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_specific_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_specification_id'], ['product_specifications.id'], name=op.f('product_specific_translations_product_specification_id_fkey')),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('product_specification_type_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('language_code_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_specification_type_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_specification_type_id'], ['product_specification_types.id'], name=op.f('product_specification_type_tr_product_specification_type_i_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('product_specification_type_translations_pkey'))
    )
    ...
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_variant_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_variant_id'], ['product_variants.id'], name=op.f('product_variant_translations_product_variant_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('product_variant_translations_pkey')),
    sa.UniqueConstraint('slug', name=op.f('product_variant_translations_slug_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('product_variant_specific_translations',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('product_variant_specification_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('language_code_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_variant_specific_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_variant_specification_id'], ['product_variant_specifications.id'], name=op.f('product_variant_specific_tran_product_variant_specificatio_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('product_variant_specific_translations_pkey'))
    )
    ...
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], name=op.f('product_translations_product_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('product_translations_pkey')),
    sa.UniqueConstraint('slug', name=op.f('product_translations_slug_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('product_variant_type_translations',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('product_variant_type_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('language_code_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['language_code_id'], ['language_codes.id'], name=op.f('product_variant_type_translations_language_code_id_fkey')),
    sa.ForeignKeyConstraint(['product_variant_type_id'], ['product_variant_types.id'], name=op.f('product_variant_type_translations_product_variant_type_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('product_variant_type_translations_pkey'))
    )
    # ### end Alembic commands ###
